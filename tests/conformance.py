...
def make_driver() -> HarnessDriver:
    # ── wiring (the only edit to this file; see DEVIATIONS.md D1) ────────────
    from candor.harness import build_harness_driver
    return build_harness_driver({
        "DeriveStatus": DeriveStatus,
        "DeriveResult": DeriveResult,
        "Prediction": Prediction,
        "RawCounts": RawCounts,
        "ComposedCounts": ComposedCounts,
    })
